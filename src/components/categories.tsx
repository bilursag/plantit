        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {categories.map((category, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group rounded-xl p-6 transition-all border border-border bg-card hover:border-primary/20"
            >
              <div className="flex items-center gap-4">
                ...
                <h3 className="text-xl font-medium dark:text-white">{category.name}</h3>
              </div>
              <div className="mt-4">
                <Link
